...
15. CSAF/VEX advisory-readiness decision for products expected to ingest vendor advisories or publish machine-readable security advisories
...
- CSAF/VEX/OpenVEX/security-advisory ingestion and publication posture where the product is a SaaS, security product, infrastructure product, developer tool, library/package, or otherwise expected to consume vendor advisories or publish machine-readable advisories
...
- CSAF/VEX/OpenVEX advisory ingestion and publication posture where applicable
...
7. Record CSAF/VEX advisory-readiness posture for products expected to ingest vendor advisories or publish machine-readable security advisories.
...
- CSAF/VEX/security-advisory ingestion or publication claims are supported by advisory-readiness evidence where applicable
...
- CSAF/VEX/security-advisory ingestion and publication posture matches implemented capability
